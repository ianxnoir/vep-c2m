type EmailWords = {
  ...
  export const writeEmail_confirm_requester = function (emailWords:EmailWords):string {
    return `
      <html>
      <head>
      ...
      <body>
        <div class="contentMargin">
            ...
            <div class="contentPadding">You have a new meeting request at ${emailWords.Fair_short_name} via Click2Match. Here are the details:</div>
            ...
            <div class="contentPadding">Confirm! Requester!</div>
        </div>
      </body>
      </html>
      `;
